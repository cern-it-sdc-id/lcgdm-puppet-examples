...
->
  exec { "configurepool":
    ...
    command     => "dmlite-shell -e 'pooladd  hdfs_pool hdfs';dmlite-shell -e 'poolmodify hdfs_pool hostname dpmhdfs02.cern.ch';dmlite-shell -e 'poolmodify hdfs_pool hostname dpmhdfs02.cern.ch'; dmlite-shell -e 'poolmodify hdfs_pool username hdfs'; dmlite-shell -e 'poolmodify hdfs_pool mode rw'",
