...
if ($local_db) {
  ...
  class{"mysql::server":
    ...
    #this is set to false in the case of an existing DPM DB or if the root user has been already created manually, for new installations it has to be set to trueq
